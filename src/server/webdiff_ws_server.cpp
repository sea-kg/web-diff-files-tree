...
WebdiffWsServer::WebdiffWsServer() {
    ...
    m_wsService.onmessage = std::bind(&WebdiffWsServer::onMessage, this, std::placeholders::_1, std::placeholders::_2);
...
void WebdiffWsServer::onMessage(const WebSocketChannelPtr& channel, const std::string& msg) {
    VvWsConnectionContext* ctx = channel->getContext<VvWsConnectionContext>();
